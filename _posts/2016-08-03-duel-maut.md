...
>This table show us the difference of each pair of fighter from group A and group B. >From this table, we can see that the smallest difference is 2, if fighter with power 17 from A fights with fighter with power 19 from B.
